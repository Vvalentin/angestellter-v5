...
== Der Microservice Angestellter

=== Der Microservice im Überblick

bla bla

.Use Cases für den Microservice "angestellter"
...
.Komponenten des Microservice "angestellter"
...
."AngestellterGetController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,AngestellterGetController,svg]
----
include::./AngestellterGetController.plantuml[]
----

.Die Klasse "AngestellterModel" für den Datenaustausch bei GET
[plantuml,AngestellterModel,svg]
----
include::./AngestellterModel.plantuml[]
----

."AngestellterWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,AngestellterWriteController,svg]
----
include::./AngestellterWriteController.plantuml[]
----
...
.Die Service-Klasse "AngestellterReadService" im Anwendungskern
[plantuml,AngestellterReadService,svg]
----
include::./AngestellterReadService.plantuml[]
----

bla bla

.Die Service-Klasse "AngestellterWriteService" im Anwendungskern
[plantuml,AngestellterWriteService,svg]
----
include::./AngestellterWriteService.plantuml[]
----
...
.Die Entity-Klasse "Angestellter" für Angestelltendaten
[plantuml,Angestellter,svg]
----
include::./Angestellter.plantuml[]
----
