...
import static com.acme.angestellter.graphql.AngestellterQueryTest.GRAPHQL_PATH;
import static com.acme.angestellter.graphql.AngestellterQueryTest.HOST;
import static com.acme.angestellter.graphql.AngestellterQueryTest.ID_PATTERN;
import static com.acme.angestellter.graphql.AngestellterQueryTest.SCHEMA;
...
class AngestellterMutationTest {
    private final HttpGraphQlClient client;

    @InjectSoftAssertions
    private SoftAssertions softly;

    AngestellterMutationTest(@LocalServerPort final int port, final ApplicationContext ctx) {
        final var getController = ctx.getBean(AngestellterMutationController.class);
